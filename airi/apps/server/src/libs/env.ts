...
const EnvSchema = object({
  ...
  // Base URL of the Python emotion-VAD microservice (services/vad).
  // Optional — the /api/v1/audio/emotion-vad route returns 503 when unset.
  VAD_SERVICE_URL: optional(string(), 'http://localhost:8000'),
