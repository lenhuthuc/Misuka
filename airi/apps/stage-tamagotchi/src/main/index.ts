...
app.whenReady().then(async () => {
  ...
  // Grant microphone permission so Web Speech API works in the renderer.
  // Electron denies all permission requests by default; without this handler
  // webkitSpeechRecognition fires onerror('audio-capture') silently.
